<?php
   ...
   $sql = "SELECT Product.*, Category.name AS category_name, product_discount.value AS discount, product_discount.discount_type
        FROM Product 
        LEFT JOIN Category ON Product.category_id = Category.id 
        LEFT JOIN product_discount ON Product.id = product_discount.product_id 
            AND product_discount.start_date <= NOW() 
            AND product_discount.end_date >= NOW()
...
$sql = "SELECT * FROM (
    SELECT Product.*, Category.name AS category_name, product_discount.value AS discount, product_discount.discount_type
    FROM Product 
    LEFT JOIN Category ON Product.category_id = Category.id 
    LEFT JOIN product_discount ON Product.id = product_discount.product_id 
        AND product_discount.start_date <= NOW() 
