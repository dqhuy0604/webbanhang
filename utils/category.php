            ...
            <div class="row d-flex">
                   ...
                   <form method="get" class="wrap-filter" id="filterForm">
                        ...
                        <div class="list-collection">
                            <div class="shop-sidebar">
                                ...
                                <select name="brand_id" class="form-control" onchange="document.getElementById('filterForm').submit()">
                                    <option value="">-- Tất cả --</option>
                                    <?php
                                    $brands = executeResult("SELECT * FROM brand");
                                    foreach ($brands as $b) {
                                        $selected = ($b['id'] == $brand_id) ? 'selected' : '';
                            ...
                            <div class="shop-sidebar">
                                ...
                                <select name="price" class="form-control" onchange="document.getElementById('filterForm').submit()">
                                    ...
                                    <option value="4" <?= $price == '1' ? 'selected' : '' ?>>2 triệu - 3 triệu </option>
                                    <option value="5" <?= $price == '2' ? 'selected' : '' ?>>3 triệu - 5 triệu</option>
                                    <option value="6" <?= $price == '3' ? 'selected' : '' ?>>Trên 5 triệu</option>
                                </select>
                            </div>
                        </div>
                    </form>
                ...
                <div class="col-75">
                    <div class="top-title-colection">
                        <div class="collection-title"><h1>Tất cả sản phẩm</h1></div>
...
<?php function renderProductItem($item) {
