        ...
        <div class="container-2">
            <div class=row>
                <div class="col-md-4">
                    <h4>HUDOSHOP</h4>
                    <ul>
                        <li>HUDOSHOP được ra đời vào 10/08/2024. HUDO mong muốn trở thành một điểm đến ưa thích, mang đến những sản phẩm có thể tiếp lửa đam mê cho các ballers.</li>
                        <li><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-geo-alt-fill" viewBox="0 0 16 16">
                            ...
                            </svg></i>   70 Tô Ký, Quận 12, Tp. Hồ Chí Minh</li>
